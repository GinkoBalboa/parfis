...
\n\
#------------ System ------------\n\
system = [geometry, timestep, geometrySize, cellSize, periodicBoundary, field] <parfis::Param> (geometry, timestep, geometrySize, cellSize, periodicBoundary, fieldTypeE, fieldTypeB, fieldStrengthE, fieldStrengthB)  # The system configuration domain  \n\
...
system.field = [typeE, typeB, strengthE, strengthB] <parfis::Param> \n\
